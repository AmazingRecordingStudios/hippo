package it.amazingrecordingstudios.codename_hippopotamos.model;
...
import it.amazingrecordingstudios.codename_hippopotamos.SharedTestUtils;
...
public class PlaylistIteratorTest {
    ...
    public void navigateAllScreens() {
        ...
        // W/SQLiteConnectionPool: A SQLiteConnection object for database '/data/user/0/it.amazingrecordingstudios.codename_hippopotamos/databases/greekquotes' was leaked!  Please fix your application to end transactions in progress properly and to close the database when it is no longer needed.
        // 2019-12-27 17:59:59.766 11380-11395/it.amazingrecordingstudios.codename_hippopotamos
